        ...
        d88a: function(t, n, e) {
            ...
            var i = (e("6762"), e("2fdb"), e("f091")),
                ...
                s = {
                    ...
                    computed: {
                        title: function() {
                            return r.l[this.accountContent]
                        },
                        subtitle: function() {
                            var t = this.profile ? this.profile.firstName : "";
                            return (r.k[this.accountContent] || function() {
                                return ""
                            })({
                                firstName: t
                            })
                        ...
                        displayLogo: function() {
                            return this.accountContent === r.b
                        }
                    },
                    methods: {
                        goToLangingPage: function() {
                            this.$emit("go-to-landing-page", {
                                redirectToProfile: [r.h, r.g].includes(this.accountContent)
                            })
                        }
                    }
                },
