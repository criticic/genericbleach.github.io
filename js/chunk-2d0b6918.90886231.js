                ...
                (function() {
                    ...
                    r.prototype = {
                        ...
                        _unlockAudio: function() {
                            ...
                            if (!e._audioUnlocked && e.ctx) {
                                ...
                                var n = function(t) {
                                    for (var o = 0; o < e.html5PoolSize; o++) try {
                                        var r = new Audio;
                                    ...
                                    d.buffer = e._scratchBuffer, d.connect(e.ctx.destination), void 0 === d.start ? d.noteOn(0) : d.start(0), "function" == typeof e.ctx.resume && e.ctx.resume(), d.onended = function() {
                                        d.disconnect(0), e._audioUnlocked = !0, document.removeEventListener("touchstart", n, !0), document.removeEventListener("touchend", n, !0), document.removeEventListener("click", n, !0);
                    ...
                    i.prototype = {
                        init: function(e) {
                            ...
                            return a.ctx || p(), n._autoplay = e.autoplay || !1, n._format = "string" != typeof e.format ? e.format : [e.format], n._html5 = e.html5 || !1, n._muted = e.mute || !1, n._loop = e.loop || !1, n._pool = e.pool || 5, n._preload = "boolean" != typeof e.preload || e.preload, n._rate = e.rate || 1, n._sprite = e.sprite || {}, n._src = "string" != typeof e.src ? e.src : [e.src], n._volume = void 0 !== e.volume ? e.volume : 1, n._xhrWithCredentials = e.xhrWithCredentials || !1, n._duration = 0, n._state = "unloaded", n._sounds = [], n._endTimers = {}, n._queue = [], n._playLock = !1, n._onend = e.onend ? [{
                                ...
                                fn: e.onunlock
                            }] : [], n._onresume = [], n._webAudio = a.usingWebAudio && !n._html5, void 0 !== a.ctx && a.ctx && a.autoUnlock && a._unlockAudio(), a._howls.push(n), n._autoplay && n._queue.push({
                                event: "play",
                                action: function() {
                                    n.play()
                                }
                        ...
                        play: function(e, n) {
                            ...
                            var s = Math.max(0, u._seek > 0 ? u._seek : t._sprite[e][0] / 1e3),
                                ...
                                f = !(!u._loop && !t._sprite[e][2]);
                            u._sprite = e, u._ended = !1;
                            var m = function() {
                                u._paused = !1, u._seek = s, u._start = c, u._stop = p, u._loop = f
                            };
                            if (!(s >= p)) {
                                var v = u._node;
                                if (t._webAudio) {
                                    var h = function() {
                                        t._playLock = !1, m(), t._refreshBuffer(u);
                                        var e = u._muted || t._muted ? 0 : u._volume;
                                        v.gain.setValueAtTime(e, a.ctx.currentTime), u._playStart = a.ctx.currentTime, void 0 === v.bufferSource.start ? u._loop ? v.bufferSource.noteGrainOn(0, s, 86400) : v.bufferSource.noteGrainOn(0, s, _) : u._loop ? v.bufferSource.start(0, s, 86400) : v.bufferSource.start(0, s, _), l !== 1 / 0 && (t._endTimers[u._id] = setTimeout(t._ended.bind(t, u), l)), n || setTimeout(function() {
                                            t._emit("play", u._id), t._loadQueue()
                                        }, 0)
                                    };
                                    "running" === a.state ? h() : (t._playLock = !0, t.once("resume", h), t._clearTimer(u._id))
                                } else {
                                    var A = function() {
                                        v.currentTime = s, v.muted = u._muted || t._muted || a._muted || v.muted, v.volume = u._volume * a.volume(), v.playbackRate = u._rate;
                                        try {
                                            var o = v.play();
                                            if (o && "undefined" != typeof Promise && (o instanceof Promise || "function" == typeof o.then) ? (t._playLock = !0, m(), o.then(function() {
                                                    t._playLock = !1, v._unlocked = !0, n || (t._emit("play", u._id), t._loadQueue())
                                                }).catch(function() {
                                                ...
                                                })) : n || (t._playLock = !1, m(), t._emit("play", u._id), t._loadQueue()), v.playbackRate = u._rate, v.paused) return void t._emit("playerror", u._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
                                            "__default" !== e || u._loop ? t._endTimers[u._id] = setTimeout(t._ended.bind(t, u), l) : (t._endTimers[u._id] = function() {
                                                t._ended(u), v.removeEventListener("ended", t._endTimers[u._id], !1)
                                    ...
                                    if (v.readyState >= 3 || y) A();
                                    else {
                                        t._playLock = !0;
                                        var g = function() {
                                            A(), v.removeEventListener(a._canPlayEvent, g, !1)
                                        };
                                        v.addEventListener(a._canPlayEvent, g, !1), t._clearTimer(u._id)
                                    }
                                }
                                return u._id
                            }
                        ...
                        fade: function(e, n, t, o) {
                            ...
                            for (var i = r._getSoundIds(o), u = 0; u < i.length; u++) {
                                ...
                                if (d) {
                                    ...
                                    r._startFadeInterval(d, e, n, t, i[u], void 0 === o)
                                }
                            }
                            return r
                        },
                        _startFadeInterval: function(e, n, t, o, r, a) {
                            ...
                            e._fadeTo = t, e._interval = setInterval(function() {
                                var r = (Date.now() - l) / o;
                                l = Date.now(), u += d * r, u = Math.max(0, u), u = Math.min(1, u), u = Math.round(100 * u) / 100, i._webAudio ? e._volume = u : i.volume(u, e._id, !0), a && (i._volume = u), (t < n && u <= t || t > n && u >= t) && (clearInterval(e._interval), e._interval = null, e._fadeTo = null, i.volume(t, e._id), i._emit("fade", e._id))
                            }, _)
                        },
                        ...
                        unload: function() {
                            for (var e = this, n = e._sounds, t = 0; t < n.length; t++) n[t]._paused || e.stop(n[t]._id), e._webAudio || (e._clearSound(n[t]._node), n[t]._node.removeEventListener("error", n[t]._errorFn, !1), n[t]._node.removeEventListener(a._canPlayEvent, n[t]._loadFn, !1), a._releaseHtml5Audio(n[t]._node)), delete n[t]._node, e._clearTimer(n[t]._id);
                    ...
                    u.prototype = {
                        ...
                        create: function() {
                            ...
                            return n._webAudio ? (e._node = void 0 === a.ctx.createGain ? a.ctx.createGainNode() : a.ctx.createGain(), e._node.gain.setValueAtTime(t, a.ctx.currentTime), e._node.paused = !0, e._node.connect(a.masterGain)) : (e._node = a._obtainHtml5Audio(), e._errorFn = e._errorListener.bind(e), e._node.addEventListener("error", e._errorFn, !1), e._loadFn = e._loadListener.bind(e), e._node.addEventListener(a._canPlayEvent, e._loadFn, !1), e._node.src = n._src, e._node.preload = "auto", e._node.volume = t * a.volume(), e._node.load()), e
                        },
                        reset: function() {
                            var e = this,
                                n = e._parent;
                    ...
                    var d = {},
                        s = function(e) {
                            ...
                            if (/^data:[^;]+;base64,/.test(n)) {
                                ...
                                a.open("GET", n, !0), a.withCredentials = e._xhrWithCredentials, a.responseType = "arraybuffer", a.onload = function() {
                                    var n = (a.status + "")[0];
                    ...
                    }.apply(n, [])) || (e.exports = o), n.Howler = a, n.Howl = i, "undefined" != typeof window ? (window.HowlerGlobal = r, window.Howler = a, window.Howl = i, window.Sound = u) : void 0 !== t && (t.HowlerGlobal = r, t.Howler = a, t.Howl = i, t.Sound = u)
                })(),
                function() {
                    "use strict";
                    HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(e) {
                        ...
                        for (var a = o._getSoundIds(t), i = 0; i < a.length; i++) {
                            ...
                            if (u) {
                                ...
                                u._stereo = n, u._pos = [n, 0, 0], u._node && (u._pannerAttr.panningModel = "equalpower", u._panner && u._panner.pan || e(u, r), "spatial" === r ? void 0 !== u._panner.positionX ? (u._panner.positionX.setValueAtTime(n, Howler.ctx.currentTime), u._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime), u._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : u._panner.setPosition(n, 0, 0) : u._panner.pan.setValueAtTime(n, Howler.ctx.currentTime)), o._emit("stereo", u._id)
                            }
                        }
                        return o
                        ...
                        for (var i = r._getSoundIds(t), u = 0; u < i.length; u++)
                            if (o = r._soundById(i[u])) {
                                ...
                                var s = o._panner;
                                s ? (s.coneInnerAngle = d.coneInnerAngle, s.coneOuterAngle = d.coneOuterAngle, s.coneOuterGain = d.coneOuterGain, s.distanceModel = d.distanceModel, s.maxDistance = d.maxDistance, s.refDistance = d.refDistance, s.rolloffFactor = d.rolloffFactor, s.panningModel = d.panningModel) : (o._pos || (o._pos = r._pos || [0, 0, -.5]), e(o, "spatial"))
                            }
                        return r
